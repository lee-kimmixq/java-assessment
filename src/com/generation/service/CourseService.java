...
public class CourseService {
    ...
    public CourseService() {
        ...
        registerCourse(new Course("INTRO-CS-3",
                "Algorithm Design and Problem Solving - Introduction ", 9, module));
        registerCourse(new Course("INTRO-CS-4", "Algorithm Design and Problem Solving - Advanced",
                9, module));
        ...
        registerCourse(
                new Course("INTRO-CS-7", "Agile Software Development with SCRUM", 9, module));
        ...
        registerCourse(new Course("INTRO-WEB-1", "Introduction to Web Applications", 9,
                moduleWebFundamentals));
        ...
        registerCourse(new Course("INTRO-WEB-6", "Introduction to Bootstrap Framework", 9,
                moduleWebFundamentals));
        registerCourse(new Course("INTRO-WEB-7", "Introduction to JavaScript for Web Development",
                9, moduleWebFundamentals));
    ...
    public void approveStudent(String courseId, Student student) {
        if (enrolledStudents.containsKey(courseId)) {
